  ...
  <div class="bg-white rounded-2xl shadow-card shadow-hover overflow-hidden hostel-card"
    ...
    <div class="p-4">
      ...
      <div class="flex items-center justify-between gap-2">
        ...
        <!-- WhatsApp Contact (Authentic White-on-Green circle) -->
        ${h.managerPhone ? `
          <a href="https://wa.me/${h.managerPhone.replace(/\D/g,'').replace(/^0/,'256')}" 
             target="_blank" onclick="event.stopPropagation()"
             class="w-9 h-9 flex items-center justify-center rounded-full bg-[#25D366] text-white hover:scale-110 transition-transform shadow-sm"
